...
elseif (WIN32)
   ...
   if (MSVC)
      ...
      if (CMAKE_SIZEOF_VOID_P EQUAL 8) # 64 bits?
         set(CAIRO_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x64/cairo-2.dll)
         set(PIXMAN_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x64/pixman-1-0.dll)
         set(PNG_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x64/png16-16.dll)
         set(Z_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x64/z.dll)
         ...
         set(CAIRO_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x86/cairo-2.dll)
         set(PIXMAN_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x86/pixman-1-0.dll)
         set(PNG_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x86/png16-16.dll)
         set(Z_DLL ${ELEMENTS_ROOT}/lib/external/cairo/lib/x86/z.dll)
      ...
      file(COPY ${PIXMAN_DLL} DESTINATION "${CMAKE_CURRENT_BINARY_DIR}")
      file(COPY ${PNG_DLL} DESTINATION "${CMAKE_CURRENT_BINARY_DIR}")
      file(COPY ${Z_DLL} DESTINATION "${CMAKE_CURRENT_BINARY_DIR}")

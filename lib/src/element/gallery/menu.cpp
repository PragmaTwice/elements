...
// Practically, one must either use std::u8string (which is not available in
// C++17), or force u8"strings" to keep creating const char*'s (even with
// C++20). This macro does the latter.
